            ...
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="staticBackdropLabel">Blog Oluştur</h5>
        ...
        <div class="row g-2">
            <div class="col-lg-auto">
                <div class="d-flex">
                    ...
                    <div class="flex-grow-1 mx-2">
                        <h5 class="font-size-16 mb-1">Admin Blog Sayfası </h5>
                        <p class="text-muted mb-0">Burada Blog Oluşturabilirsiniz Ve Oluşturduğunuz Blogları Silebilir Ve Güncelleyebilirsiniz.</p>
                    </div>
            ...
            <div class="col-auto ms-sm-auto">
                ...
                <div class="avatar-group justify-content-sm-end">
                    ...
                    <div class="avatar-group-item">
                        <a href="javascript: void(0);" data-bs-toggle="modal" data-bs-target="#staticBackdrop" class="d-block" data-placement="top">
                            <div class="avatar">
                                <div class="avatar-title rounded-circle bg-light text-primary">
                                    <i class="uil-comment-plus fs-5"></i>
                                </div>
                            </div>
                        </a>
                    </div>
